...
| `choice.AtomicDipolesMACE` | `--model AtomicDipolesMACE` | `mace/tools/arg_parser.py:144` | MERGE — idem, selected by declaring the dipole observable | `tests/golden/test_tiny_dipoles.py::test_anchor_is_the_class_it_claims_to_be` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `choice.AtomicDielectricMACE` | `--model AtomicDielectricMACE` | `mace/tools/arg_parser.py:145` | MERGE — idem, dipole + polarizability observables | `tests/golden/test_mdp_foundation.py::test_mdp_foundation_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
...
| `choice.MagneticScaleShiftMACE` | `--model MagneticScaleShiftMACE` | `mace/tools/arg_parser.py:147` | MERGE — idem; the only magnetic entry in the choices | `tests/extensions/magnetic` + `tests/golden/test_tiny_magnetic.py::test_anchor_reproduces_its_reference` + `tests/parity/test_magnetic_parity.py::test_the_converted_model_reproduces_the_committed_reference` (v1 parity) |
...
| `train.compute_magforces` | `--compute_magforces` | `mace/tools/arg_parser.py:444` | MERGE — idem: `dE/dm` is a declared derivative exactly like forces and stress | `tests/golden/test_tiny_magnetic.py::test_compute_magforces_is_only_honoured_alongside_the_forces` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_the_derivative_at_a_zero_moment_is_the_finite_difference` |
...
| `train.multi_processed_test` | `--multi_processed_test` | `mace/tools/arg_parser.py:484` | MERGE — the data layer infers sharding from the dataset; whether a test set is split across files is not something the user should have to declare and get wrong (today it is a bare `if` in `run_train.py`) | `tests/workflows/test_multi_processed_test_layout.py` (both layouts, from a real `mace_prepare_data` run, and both mismatches) + `packages/mace-core/tests/test_data_backend_conformance.py::test_uneven_shards_are_counted_exactly` + `tests/parity/test_data_backend_parity.py::test_auto_takes_the_prepared_directories_for_the_legacy_layout` (v1 parity) |
...
| `train.statistics_file` | `--statistics_file` | `mace/tools/arg_parser.py:524` | KEEP | `tests/workflows/test_preprocess.py` + `packages/mace-core/tests/test_data_backend_conformance.py::test_the_legacy_statistics_parse_follows_a_named_energies_file` + `tests/parity/test_data_backend_parity.py::test_the_prepared_statistics_parse_to_what_the_frozen_tree_evaluates` (v1 parity) |
...
| `train.pseudolabel_replay` | `--pseudolabel_replay` | `mace/tools/arg_parser.py:547` | KEEP | `tests/workflows/test_finetuning_contracts.py::test_pseudolabel_replay_relabels_the_replay_set_from_the_foundation_model` + `tests/workflows/test_finetuning_contracts.py::test_a_failing_pseudolabel_batch_keeps_the_file_labels_and_says_nothing` + `packages/mace-torch/tests/test_mace_torch_pseudolabels.py::test_a_run_writes_its_labels_into_its_own_directory` + `packages/mace-torch/tests/test_mace_torch_pseudolabels.py::test_a_failing_batch_stops_everything` + `tests/parity/test_pseudolabel_parity.py::test_the_labels_and_their_weights_are_the_frozen_tree_s` (v1 parity) |
| `train.pseudolabel_replay_compute_stress` | `--pseudolabel_replay_compute_stress` | `mace/tools/arg_parser.py:553` | KEEP | `tests/unit/test_multihead_tools.py::test_forcing_it_adds_the_stress_the_model_predicts` + `packages/mace-torch/tests/test_mace_torch_pseudolabels.py::test_a_stress_keeps_the_weight_its_file_gave_it` |
| `train.foundation_model_elements` | `--foundation_model_elements` | `mace/tools/arg_parser.py:640` | KEEP — all-species weight saving is a v1 default | `tests/workflows/test_run_train.py::test_run_train_foundation_elements` + `tests/workflows/test_run_train.py::test_run_train_foundation_elements_multihead` + `tests/parity/test_element_table_parity.py::test_the_data_s_table_is_the_frozen_tree_s_sliced_model` + `tests/parity/test_element_table_parity.py::test_the_foundation_s_table_computes_what_the_anchor_does` (v1 parity) |
...
| `train.finetune_dipoles_polarizabilities` | `--finetune_dipoles_polarizabilities` | `mace/tools/arg_parser.py:1037` | KEEP — the MDP fine-tuning path. In v1 there is no mode: a fine-tune declaring the dipole and polarizability observables from a dielectric foundation is one, and the element transfer carries every angular channel | `tests/workflows/test_mdp_finetune.py::test_mdp_finetune_updates_params` + `tests/workflows/test_mdp_finetune.py::test_mdp_finetune_wrong_model_type_raises` + `packages/mace-torch/tests/test_mace_torch_dielectric_finetune.py::test_a_dielectric_fine_tune_trains_from_the_foundation` + `packages/mace-torch/tests/test_mace_torch_dielectric_finetune.py::test_a_foundation_that_reads_out_no_dipole_is_refused` + `tests/parity/test_dielectric_finetune_parity.py::test_the_data_s_table_is_the_frozen_tree_s_dielectric_transfer` (v1 parity) |
...
| `train.m_max` | `--m_max` | `mace/tools/arg_parser.py:1160` | KEEP — magnetic architecture hyper | `tests/extensions/magnetic` (7 `resolve_m_max` cases) + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_an_unlisted_element_saturates_at_one_and_an_extra_one_is_ignored` + `packages/mace-core/tests/test_magnetic_config.py::test_a_list_of_the_wrong_length_is_refused_at_build` + `packages/mace-core/tests/test_magnetic_config.py::test_a_dict_literal_saturates_what_it_lists_and_one_elsewhere` |
| `train.max_m_ell` | `--max_m_ell` | `mace/tools/arg_parser.py:1172` | KEEP — idem | `tests/extensions/magnetic` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_a_magnetic_model_comes_back_from_its_checkpoint` |
| `train.num_mag_radial_basis` | `--num_mag_radial_basis` | `mace/tools/arg_parser.py:1178` | KEEP — idem | `tests/extensions/magnetic` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_a_magnetic_model_comes_back_from_its_checkpoint` |
| `train.num_mag_radial_basis_one_body` | `--num_mag_radial_basis_one_body` | `mace/tools/arg_parser.py:1154` | KEEP — idem | `tests/extensions/magnetic` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_the_one_body_term_reads_the_moment_length_alone` |
| `train.use_magmom_one_body` | `--use_magmom_one_body` | `mace/tools/arg_parser.py:1184` | KEEP — the one-body magmom term | `tests/golden/test_tiny_magnetic.py::test_the_one_body_magnetic_term_is_inside_the_reference` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_the_one_body_term_reads_the_moment_length_alone` |
| `train.train_one_body_contribution` | `--train_one_body_contribution` | `mace/tools/arg_parser.py:1190` | KEEP — whether the one-body coefficients are optimized | `tests/golden/test_tiny_magnetic.py::test_not_training_it_requires_freezing_it_first` + `::test_training_the_one_body_term_gives_it_its_own_parameter_group` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_one_body_coefficients_that_are_not_trained_keep_their_values` |
| `train.data_aug_magmom` | `--data_aug_magmom` | `mace/tools/arg_parser.py:1197` | MERGE — a training-data transform (`Random3DRotation`), not a model flag | `tests/extensions/magnetic` (rotation equivariance) + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_a_configured_augmentation_reaches_the_training_batches_alone` + `packages/mace-core/tests/test_magnetic_config.py::test_the_other_magnetic_flags_land_on_the_section` |
| `train.data_aug_magmom_mode` | `--data_aug_magmom_mode` | `mace/tools/arg_parser.py:1203` | MERGE — selects which spin symmetry the transform draws from (`non-soc` the full O(3), `soc` the sign flip alone), so it travels with `data_aug_magmom` | `tests/extensions/magnetic/test_magmom_augmentation.py::test_non_soc_mode_samples_the_full_o3` + `packages/mace-torch/tests/test_mace_torch_magnetic_augmentation.py::test_with_spin_orbit_coupling_only_the_reversal_is_drawn` |
...
| `model.AtomicDipolesMACE` | `AtomicDipolesMACE` | `mace/modules/models.py:626` | MERGE — the dipole observable | `tests/golden/test_tiny_dipoles.py::test_anchor_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `model.AtomicDielectricMACE` | `AtomicDielectricMACE` | `mace/modules/models.py:842` | MERGE — dipole + polarizability observables. Note this is the MACE-MDP foundation architecture, so it needs a converter as well as a reimplementation | `tests/golden/test_mdp_foundation.py::test_mdp_foundation_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
...
| `model.MagneticMACE` | `MagneticMACE` | `mace/modules/extensions.py:1428` | KEEP — the magnetic base class: magmom as an input feature, magnetic-moment observable, `dE/dm` derivative | `tests/extensions/magnetic` (rotation equivariance, inversion parity) + `tests/golden/test_tiny_magnetic.py::test_a_joint_rotation_is_a_symmetry_and_a_spin_only_one_is_not` + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) |
| `model.MagneticScaleShiftMACE` | `MagneticScaleShiftMACE` | `mace/modules/extensions.py:1706` | KEEP — the CLI-reachable magnetic model | `tests/extensions/magnetic` (e2e train, eval, config round-trip) + `tests/golden/test_tiny_magnetic.py::test_the_eval_cli_reproduces_the_reference_including_magforces` + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) + `tests/parity/test_magnetic_parity.py::test_the_converted_model_reproduces_the_committed_reference` (v1 parity) |
| `model.MagneticSCFMACE` | `MagneticSCFMACE` | `mace/modules/extensions.py:1968` | KEEP — **not CLI-reachable**: a wrapper applied programmatically over a model (`MagneticSCFMACE(model=…, n_scf_step=2)`). That shape is what a model-transform hook has to support, so it is the in-tree consumer to design one against | `tests/extensions/magnetic::test_run_magnetic_scf` + `tests/parity/test_magnetic_parity.py::test_the_fixed_point_reproduces_the_committed_reference` (v1 parity) + `tests/parity/test_magnetic_parity.py::test_the_frozen_wrapper_stops_short_of_its_own_tolerance` (v1 parity) |
...
| `model.SHModule` | `SHModule` | `mace/modules/extensions.py:1351` | KEEP — a spherical-harmonics block wrapping `sphericart.torch.SolidHarmonics`, not a model. Notable as a working in-tree precedent for a non-e3nn spherical-harmonics backend | `tests/extensions/magnetic` (indirect) + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) |
...
| `reg.LinearDipoleReadoutBlock` | `LinearDipoleReadoutBlock` — readout_classes | `mace/modules/__init__.py:83` | MERGE — an observable head declared in the output spec | `tests/golden/test_tiny_dipoles.py::test_anchor_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `reg.NonLinearDipoleReadoutBlock` | `NonLinearDipoleReadoutBlock` — readout_classes | `mace/modules/__init__.py:84` | MERGE — idem | `tests/golden/test_tiny_dipoles.py::test_anchor_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
...
| `block.LinearDipoleReadoutBlock` | `LinearDipoleReadoutBlock` | `mace/modules/blocks.py:163` | KEEP — the dipole family's readout | `tests/unit/test_models.py::test_dipole_mace` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `block.NonLinearDipoleReadoutBlock` | `NonLinearDipoleReadoutBlock` | `mace/modules/blocks.py:185` | KEEP — idem, nonlinear | `tests/unit/test_models.py::test_dipole_mace` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `block.LinearDipolePolarReadoutBlock` | `LinearDipolePolarReadoutBlock` | `mace/modules/blocks.py:233` | KEEP — dipole and polarizability together | `tests/unit/test_models.py::test_dipole_polar_mace` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
| `block.NonLinearDipolePolarReadoutBlock` | `NonLinearDipolePolarReadoutBlock` | `mace/modules/blocks.py:262` | KEEP — idem, nonlinear | `tests/unit/test_models.py::test_dipole_polar_mace` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
...
| `block.MagneticInteractionBlock` | `MagneticInteractionBlock` | `mace/modules/blocks.py:1602` | KEEP — the magnetic interactions' base class | `tests/extensions/magnetic/test_magmace.py::test_run_train_magnetic_mace` + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) |
| `block.MagneticRealAgnosticSpinOrbitCoupledDensityInteractionBlock` | `MagneticRealAgnosticSpinOrbitCoupledDensityInteractionBlock` | `mace/modules/blocks.py:1632` | KEEP — the SOC magnetic interaction | `tests/extensions/magnetic/test_magmace.py::test_run_magnetic_scf` + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) |
| `block.MagneticRealAgnosticResidueSpinOrbitCoupledDensityInteractionBlock` | `MagneticRealAgnosticResidueSpinOrbitCoupledDensityInteractionBlock` | `mace/modules/blocks.py:1785` | MERGE — the residual SOC variant | `tests/extensions/magnetic/test_magnetic_interaction_variants.py::test_the_residual_soc_interaction_builds_and_runs` + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) |
| `block.EquivariantProductBasisWithSelfMagmomBlock` | `EquivariantProductBasisWithSelfMagmomBlock` | `mace/modules/blocks.py:517` | KEEP — the product basis that carries the site's own moment | `tests/extensions/magnetic/test_magmace.py::test_magnetic_mace_registers_all_trainable_parameters` (built by `MagneticMACE.__init__` for every layer) + `tests/parity/test_magnetic_parity.py::test_the_converted_model_matches_the_live_legacy_model` (v1 parity) |
...
| `transform.Random3DRotation` | `Random3DRotation` | `mace/data/augmentation.py:24` | MERGE — the `--data_aug_magmom` transform, which travels with the flag | `tests/extensions/magnetic/test_magmom_augmentation.py::test_non_soc_mode_samples_the_full_o3` + `packages/mace-torch/tests/test_mace_torch_magnetic_augmentation.py::test_the_orientations_are_uniform` + `packages/mace-torch/tests/test_mace_torch_magnetic_augmentation.py::test_the_moments_and_their_forces_turn_by_one_transform` |
...
| `calc.class.MagneticMACECalculator` | `MagneticMACECalculator` | `mace/calculators/mace.py:964` | KEEP — the magnetic ASE calculator | `tests/extensions/magnetic/test_magmace.py::test_run_train_magnetic_mace` + `tests/parity/test_magnetic_parity.py::test_the_calculator_gives_the_frozen_calculator_s_results` (v1 parity) |
...
| `calc.param.magmom_key` | `magmom_key` — MagneticMACECalculator | `mace/calculators/mace.py:993` | KEEP — property-key convention; `MagneticMACECalculator` only | `tests/extensions/magnetic` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_the_moments_can_be_read_from_another_key` + `packages/mace-torch/tests/test_mace_torch_magnetic_model.py::test_changing_the_moments_invalidates_the_cached_energy` |
...
| `out.model.dipole` | `dipole` — first declared by `AtomicDipolesMACE` | `mace/modules/models.py:835` | KEEP — a declared observable | `tests/golden/test_tiny_dipoles.py::test_anchor_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `out.model.atomic_dipoles` | `atomic_dipoles` — first declared by `AtomicDipolesMACE` | `mace/modules/models.py:836` | KEEP — idem | `tests/golden/test_tiny_dipoles.py::test_anchor_reproduces_its_reference` + `tests/parity/test_dipole_parity.py::test_the_dipole_anchor_matches_the_live_legacy_model` (v1 parity) |
| `out.model.charges` | `charges` — first declared by `AtomicDielectricMACE` | `mace/modules/models.py:1187` | KEEP — idem | `tests/golden/test_tiny_dipoles.py::test_the_fixed_charge_baseline_is_live` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
| `out.model.polarizability` | `polarizability` — first declared by `AtomicDielectricMACE` | `mace/modules/models.py:1190` | KEEP — idem | `tests/golden/test_mdp_foundation.py::test_the_reference_pins_the_polarizability_and_its_derivatives` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
| `out.model.polarizability_sh` | `polarizability_sh` — first declared by `AtomicDielectricMACE` | `mace/modules/models.py:1191` | KEEP — the spherical-harmonics form of the polarizability | `tests/golden/test_mdp_foundation.py::test_the_reference_pins_the_polarizability_and_its_derivatives` + `tests/parity/test_dipole_parity.py::test_the_dielectric_model_matches_the_live_legacy_model` (v1 parity) |
...
| `out.model.scf_steps` | `scf_steps` — first declared by `MagneticSCFMACE` | `mace/modules/extensions.py:2102` | MERGE — SCF solver diagnostics belong to the model-transform hook, not to the model's output contract | `tests/extensions/magnetic::test_run_magnetic_scf` + `tests/parity/test_magnetic_parity.py::test_the_fixed_point_reproduces_the_committed_reference` (v1 parity) |
...
| `out.model.equilibrated_magmom` | `equilibrated_magmom` — first declared by `MagneticSCFMACE` | `mace/modules/extensions.py:2103` | KEEP — the converged magnetic moments are a result, not a diagnostic | `tests/extensions/magnetic::test_run_magnetic_scf` + `tests/parity/test_magnetic_parity.py::test_the_fixed_point_is_the_live_wrapper_s` (v1 parity) |
...
| `out.calc.dipole` | `dipole` — results_map | `mace/calculators/mace.py:734` | KEEP | `tests/golden/test_mdp_foundation.py::test_the_calculator_surface_is_the_dipole_polarizability_one` + `tests/parity/test_calculator_families_parity.py::test_the_dipole_surface_is_the_frozen_calculator_s` (v1 parity) |
| `out.calc.charges` | `charges` — results_map | `mace/calculators/mace.py:735` | KEEP | `tests/unit/test_calculator_charges_key.py::test_charges_reach_the_fixed_charge_dipole_baseline` + `tests/parity/test_calculator_families_parity.py::test_the_dielectric_surface_is_the_frozen_calculator_s` (v1 parity) |
| `out.calc.polarizability` | `polarizability` — results_map | `mace/calculators/mace.py:736` | KEEP | `tests/golden/test_mdp_foundation.py::test_the_calculator_surface_is_the_dipole_polarizability_one` + `tests/parity/test_calculator_families_parity.py::test_the_dielectric_surface_is_the_frozen_calculator_s` (v1 parity) |
| `out.calc.polarizability_sh` | `polarizability_sh` — results_map | `mace/calculators/mace.py:737` | KEEP | `tests/golden/test_mdp_foundation.py::test_the_calculator_surface_is_the_dipole_polarizability_one` + `tests/parity/test_calculator_families_parity.py::test_the_dielectric_surface_is_the_frozen_calculator_s` (v1 parity) |
...
| `out.calc.fukui_functions` | `fukui_functions` — implemented_properties | `mace/calculators/mace.py:227` | KEEP | `tests/extensions/polar/test_polar_models.py::test_polar_calculator_returns_fukui_functions_by_default` + `packages/mace-torch/tests/test_mace_torch_polar_calculator.py::test_every_polar_result_has_the_frozen_tree_s_name_and_shape` (v1) |
...
| `out.calc.MACE_magmoms` | `MACE_magmoms` — self.results[...] | `mace/calculators/mace.py:1411` | MERGE — idem: the magnetic calculator's spelling of the magnetic-moment observable, also written back into `atoms.arrays` | `tests/extensions/magnetic` + `tests/parity/test_magnetic_parity.py::test_the_calculator_relaxes_the_moments_as_the_frozen_wrapper_does` (v1 parity) |
...
| `out.calc.dipole_comm` | `dipole_comm` — committee | `mace/calculators/mace.py:718` | KEEP — committee output (per-model dipoles). The committee is the part of `mace_active_learning_md` that MACE must keep guaranteeing (§1) | `tests/unit/test_calculator_units_and_spread.py::test_a_dipole_committee_reports_its_spread` + `tests/parity/test_calculator_families_parity.py::test_the_dielectric_surface_is_the_frozen_calculator_s` (v1 parity) |
| `out.calc.dipole_var` | `dipole_var` — committee | `mace/calculators/mace.py:718` | KEEP — committee output (dipole variance). The committee is the part of `mace_active_learning_md` that MACE must keep guaranteeing (§1) | `tests/unit/test_calculator_units_and_spread.py::test_a_dipole_committee_reports_its_spread` + `tests/unit/test_calculator_units_and_spread.py::test_the_dipole_spread_keeps_the_layout_of_the_dipole` + `tests/parity/test_calculator_families_parity.py::test_the_dielectric_surface_is_the_frozen_calculator_s` (v1 parity) |
...
| `key.DIPOLE` | `DIPOLE` = `"dipole"` | `mace/tools/default_keys.py:11` | KEEP — the default name is part of the data contract; a rename needs an explicit old→new mapping in the release notes | `tests/unit/test_data_utils.py::test_default_keys_are_exactly_these_thirteen` + `tests/unit/test_data_utils.py::test_custom_property_keys_round_trip` + `packages/mace-core/tests/test_data_configuration.py::test_the_default_keys_are_exactly_these_thirteen` + `packages/mace-core/tests/test_data_configuration.py::test_the_default_dipole_key_is_read_back_from_the_calculator` |
...
| `method.get_hessian` | `MACECalculator.get_hessian` — analytical Hessians, including the polar variant | `mace/calculators/mace.py` | KEEP | `tests/foundations/test_hessian.py` (port cases) + `packages/mace-torch/tests/test_mace_torch_polar_calculator.py::test_the_hessian_is_the_derivative_of_the_forces` (v1) |
...
| `method.get_dielectric_derivatives` | `MACECalculator.get_dielectric_derivatives` — `dmu/dr`, `dalpha/dr` | `mace/calculators/mace.py` | KEEP | `tests/golden/test_mdp_foundation.py::test_the_reference_pins_the_polarizability_and_its_derivatives` + `tests/parity/test_calculator_families_parity.py::test_the_dielectric_surface_is_the_frozen_calculator_s` + `tests/parity/test_calculator_families_parity.py::test_the_dipole_surface_is_the_frozen_calculator_s` (v1 parity) |
...
| id | feature | source | disposition | pinned by |
|---|---|---|---|---|
| `pkg.fairchem_lmdb` | FairChem LMDB dataset tools — reading FairChem-format LMDB shards | `mace/tools/fairchem_dataset/lmdb_dataset_tools.py` | KEEP — becomes a dataset backend: OMat24 and OMol25 ship in this format and MACE has models trained on both, so dropping it would mean re-converting terabyte-scale datasets | `tests/unit/test_lmdb_database.py` + `packages/mace-core/tests/test_data_backend_conformance.py::test_a_damaged_lmdb_row_raises_naming_its_database_and_index` + `tests/parity/test_data_backend_parity.py::test_lmdb_rows_read_as_the_frozen_reader_reads_them` (v1 parity) |
| `pkg.hdf5_dataset` | HDF5 shard reader/writer for on-line loading | `mace/data/hdf5_dataset.py` | KEEP — HDF5 v2 (read + write) plus a legacy-HDF5 read path | `tests/workflows/test_preprocess.py` + `packages/mace-core/tests/test_data_shard_format.py::test_every_field_and_property_round_trips` + `tests/parity/test_data_backend_parity.py::test_the_prepared_shards_read_as_the_frozen_reader_reads_them` + `tests/parity/test_data_backend_parity.py::test_a_short_last_group_is_counted_where_the_frozen_reader_overstates` (v1 parity) |
| `pkg.lmdb_dataset` | LMDB shard reader, honouring the CLI key specification | `mace/data/lmdb_dataset.py` | KEEP — read support | `tests/unit/test_lmdb_database.py` + `packages/mace-core/tests/test_data_backend_conformance.py::test_an_lmdb_row_s_calculator_labels_become_its_properties` + `tests/parity/test_data_backend_parity.py::test_lmdb_rows_read_as_the_frozen_reader_reads_them` (v1 parity) |
...
| `pkg.statistics_json` | `statistics.json` — the preprocessing side-car carrying E0s, avg neighbours, mean/std and the atomic numbers | `mace/cli/preprocess_data.py` | KEEP — becomes part of the dataset metadata contract | `tests/workflows/test_preprocess.py` + `packages/mace-core/tests/test_data_shard_format.py::test_the_manifest_is_real_json_with_real_types` + `tests/parity/test_data_backend_parity.py::test_the_prepared_statistics_parse_to_what_the_frozen_tree_evaluates` (v1 parity) |
...
| `pkg.augmentation` | `Random3DRotation` — the training-data augmentation transform behind `--data_aug_magmom` | `mace/data/augmentation.py` | MERGE — a registered training-data transform, not a model flag | `tests/extensions/magnetic` (rotation equivariance) + `packages/mace-torch/tests/test_mace_torch_magnetic_augmentation.py::test_it_is_drawn_on_every_read_of_a_training_structure_and_of_no_other` |
